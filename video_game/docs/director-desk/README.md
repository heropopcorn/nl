...
- 环境支持早晨、中午、傍晚、夜晚与强度变化明确的夜间月光，并支持随机双段闪电。风具有方向、风力与 1×–20× 独立风速，细风丝会在固定位置逐步延伸、尾部淡出并轻微摆动，少量风丝带有短小卷尾，同时实时改变雨滴倾斜；降雨区域内部会均匀生成独立落点，每个可见雨滴都从屏幕顶部落向自己的落点，并可逐区决定是否显示同步水花。
